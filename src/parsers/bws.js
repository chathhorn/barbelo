// Bridgemate BWS ingestion: conservative Jet3 row scanning, decoding,
// diagnostics, and the CSV parser re-export used by the legacy API.

import { safeNumber } from "../core/format.js";
import { normalizePlayedContractText } from "../core/contracts.js";
import { SEATS } from "../core/constants.js";
