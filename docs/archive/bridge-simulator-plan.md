...
- Original simulator art, procedural audio, captions, semantic coaching overlays, reduced effects, high contrast, keyboard fallback, Pointer Lock failure handling, and context-loss recovery are present. The world Coach is non-blocking/invulnerable and gives a captioned ally response when struck by a thrown card.
